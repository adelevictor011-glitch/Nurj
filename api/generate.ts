import { assertText, fail, json, readJson, safeMessage } from '../_lib/http.js';
import { consumeGuestQuota, guestFingerprint, GuestQuotaError, refundGuestQuota } from '../_lib/guest.js';
import { createStructuredResponse } from '../_lib/openai.js';
import { buildGenerateInput, generateSchema, GENERATE_INSTRUCTIONS, type GeneratedPayload } from '../_lib/prompts.js';
import { adminClient } from '../_lib/supabase.js';
import { logModelUsage } from '../_lib/telemetry.js';
